...
import {
    ...
    RefreshCw, UserCheck, Check, X, Ban, Filter
} from 'lucide-react';
import {
        ...
        <div className="min-h-screen bg-slate-50 font-sans">
            ...
            <div className="mx-auto max-w-6xl px-6 py-10">
                <div className="mb-8 flex items-start justify-between gap-4">
                    <div>
                        <div className="mb-2 inline-flex items-center gap-2 rounded-full border border-indigo-100 bg-indigo-50 px-3 py-1 text-[10px] font-black uppercase tracking-widest text-indigo-600">
                            Admin Panel
                        </div>
